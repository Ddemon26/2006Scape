...
Defined in [`2006Scape Client/src/main/java/core/GameUtils.java`](../../2006Scape%20Client/src/main/java/core/GameUtils.java).

Utility helpers extracted from the large [`Game`](Game.md) class.
