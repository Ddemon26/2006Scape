...
The server module contains the game logic and world simulation. The entry point is the `GameEngine` class and all code lives under [`2006Scape Server/src/main/java`](../2006Scape%20Server/src/main/java).
