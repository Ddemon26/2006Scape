...
Defined in [`2006Scape Server/src/main/java/com/rs2/game/players/Position.java`](2006Scape Server/src/main/java/com/rs2/game/players/Position.java).

Position @author Andrew (I'm A Boss on Rune-Server, Mr Extremez on Moparscape & Runelocus)
