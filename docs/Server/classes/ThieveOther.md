...
Defined in [`2006Scape Server/src/main/java/com/rs2/game/content/skills/thieving/ThieveOther.java`](2006Scape Server/src/main/java/com/rs2/game/content/skills/thieving/ThieveOther.java).

Thieveother @author Andrew (Mr Extremez)
