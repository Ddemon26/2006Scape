...
Defined in [`2006Scape Server/src/main/java/com/rs2/game/content/randomevents/Frog.java`](2006Scape Server/src/main/java/com/rs2/game/content/randomevents/Frog.java).

Frog Event @author Andrew (I'm A Boss on Rune-Server, Mr Extremez on Moparscape & Runelocus)
