...
public Slayer(game.entities.Player player)
public int getId()
...
public static boolean getMasterRequirment(game.entities.Player player, int id)
...
public int getSlayerDifficulty(game.entities.Player c2)
