...
public class NodeHashTableTest {
  ...
  public void testHashCollisionHandling() {
    ...
    assertSame(
        "Should find first node despite potential collision", node1, hashTable.findNodeById(id1));
    assertSame(
        "Should find second node despite potential collision", node2, hashTable.findNodeById(id2));
  }
