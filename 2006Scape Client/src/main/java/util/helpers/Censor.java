package util.helpers; // Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
          ...
          if (!flag5 || !flag6) {
            ...
            for (; !flag7 && k2 < l; k2++) {
              if (k2 >= 0 && (!isNonAlphanumeric(text[k2]) || text[k2] == '\'')) {
                ...
                int j3;
                for (j3 = 0; j3 < 3; j3++) {
                  if (k2 + j3 >= text.length
                      || isNonAlphanumeric(text[k2 + j3]) && text[k2 + j3] != '\'') {
                    break;
                  }
                  tmp[j3] = text[k2 + j3];
                }
                ...
                if (j3 < 3
                    && k2 - 1 >= 0
                    && (!isNonAlphanumeric(text[k2 - 1]) || text[k2 - 1] == '\'')) {
                  flag8 = false;
                }
  ...
  private static int matchLeetCharacter(char nextChar, char currentChar, char patternChar) {
    ...
    if (patternChar >= 'a' && patternChar <= 'm') {
      ...
      if (patternChar == 'b') {
        ...
        return (currentChar != '1' || nextChar != '3') && (currentChar != 'i' || nextChar != '3')
            ? 0
            : 2;
      }
      if (patternChar == 'c') {
      ...
      if (patternChar == 'd') {
        return (currentChar != '[' || nextChar != ')') && (currentChar != 'i' || nextChar != ')')
            ? 0
            : 2;
      }
      if (patternChar == 'e') {
    ...
    if (patternChar >= 'n' && patternChar <= 'z') {
      ...
      if (patternChar == 's') {
        return currentChar != '5' && currentChar != 'z' && currentChar != '$' && currentChar != '2'
            ? 0
            : 1;
      }
      if (patternChar == 't') {
