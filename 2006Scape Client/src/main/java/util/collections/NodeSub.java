package util.collections;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
public class NodeSub extends Node {
	...
	NodeSub nextNodeSub;
    /** Tracks the total number of util.collections.NodeSub instances created. */
