				...
				do {
					...
					if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
						ObjectDef class46 = ObjectDef.forID(l1);
                                                int j4 = j + TileRotation.rotateXForSize(j1, class46.anInt761, i3 & 7, l2 & 7, class46.anInt744);
                                                int k4 = k1 + TileRotation.rotateYForSize(l2 & 7, class46.anInt761, j1, class46.anInt744, i3 & 7);
