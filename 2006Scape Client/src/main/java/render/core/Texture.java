...
public final class Texture extends DrawingArea {
  ...
  public static void drawGouraudTriangle(
  ...
  private static void drawGouraudScanline(int ai[], int i, int l, int i1, int j1, int k1) {
    ...
    if (ClientSettings.FIX_TRANSPARENCY_OVERFLOW) {
      do {
        ...
        ai[i] =
            j + ((ai[i] & 0xff00ff) * k2 >> 8 & 0xff00ff) + ((ai[i] & 0xff00) * k2 >> 8 & 0xff00);
        i++;
      } while (--k > 0);
    } else {
      do {
  ...
  private static void drawFlatScanline(int ai[], int i, int j, int l, int i1) {
    ...
    if (ClientSettings.FIX_TRANSPARENCY_OVERFLOW) {
      while (--k >= 0) {
        ai[i] =
            j + ((ai[i] & 0xff00ff) * j1 >> 8 & 0xff00ff) + ((ai[i] & 0xff00) * j1 >> 8 & 0xff00);
        i++;
        ai[i] =
            j + ((ai[i] & 0xff00ff) * j1 >> 8 & 0xff00ff) + ((ai[i] & 0xff00) * j1 >> 8 & 0xff00);
        i++;
  ...
  public static void drawTexturedTriangle(
    ...
    if (i <= j && i <= k) {
      ...
      while (--k >= 0) {
        drawTexturedScanline(
            DrawingArea.pixels, ai, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
        i1 += i8;
        l += i7;
        l1 += j8;
        k1 += j7;
      ...
      while (--j >= 0) {
        drawTexturedScanline(
            DrawingArea.pixels, ai, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
        j1 += k7;
        l += i7;
        i2 += l7;
        k1 += j7;
    ...
    if (j <= k) {
      ...
      while (--k >= 0) {
        drawTexturedScanline(
            DrawingArea.pixels, ai, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
        l += i8;
        i1 += k7;
        k1 += j8;
        l1 += l7;
    ...
    if (i < j) {
      ...
      while (--j >= 0) {
        drawTexturedScanline(
            DrawingArea.pixels, ai, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
        i1 += k7;
        l += i7;
        l1 += l7;
        k1 += j7;
    ...
    if (k7 < i8) {
      ...
      while (--j >= 0) {
        drawTexturedScanline(
            DrawingArea.pixels, ai, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
        l += k7;
        j1 += i8;
        k1 += l7;
        i2 += j8;
    ...
    while (--j >= 0) {
      drawTexturedScanline(
          DrawingArea.pixels, ai, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
      l += k7;
      j1 += i8;
      k1 += l7;
      i2 += j8;
    ...
    while (--i >= 0) {
      drawTexturedScanline(
          DrawingArea.pixels, ai, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
      i1 += i7;
      j1 += i8;
      l1 += j7;
      i2 += j8;
