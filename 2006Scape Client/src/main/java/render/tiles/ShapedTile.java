package render.tiles; // Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
public final class ShapedTile {
  ...
  public final int[] faceColorA;
  public final int[] faceColorB;
  public final int[] faceColorC;
  ...
  public static final int[] cameraVertexX = new int[6];
  public static final int[] cameraVertexY = new int[6];
  public static final int[] cameraVertexZ = new int[6];
  static final int[] faceOrderA = {1, 0};
  static final int[] faceOrderB = {2, 1};
  static final int[] faceOrderC = {3, 3};
  private static final int[][] shapeVertexIndices = {
    {1, 3, 5, 7},
    {1, 3, 5, 7},
    {1, 3, 5, 7},
    {1, 3, 5, 7, 6},
