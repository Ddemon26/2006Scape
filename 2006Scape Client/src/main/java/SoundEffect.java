...
final class SoundEffect {
	...
	public int[] method167(int i, int j) {
		...
		for (int k2 = 0; k2 < i; k2++) {
			...
			for (int l5 = 0; l5 < 5; l5++) {
				if (anIntArray106[l5] != 0) {
					...
					if (l6 < i) {
						anIntArray115[l6] += method168(j4 * anIntArray120[l5] >> 15, anIntArray118[l5], aSoundEnvelope_98.anInt540);
		...
		if (aSoundFilter_111.anIntArray665[0] > 0 || aSoundFilter_111.anIntArray665[1] > 0) {
			...
			int k3 = aSoundEnvelope_112.method328(i + 1);
			int i5 = aSoundFilter_111.evaluate(0, k3 / 65536F);
			int i6 = aSoundFilter_111.evaluate(1, k3 / 65536F);
			if (i >= i5 + i6) {
				int j7 = 0;
				int l7 = i6;
				if (l7 > i - i5) {
				...
				for (; j7 < l7; j7++) {
					...
					anIntArray115[j7] = j8;
					k3 = aSoundEnvelope_112.method328(i + 1);
				}
				...
				do {
					...
					i5 = aSoundFilter_111.evaluate(0, k3 / 65536F);
					i6 = aSoundFilter_111.evaluate(1, k3 / 65536F);
					l7 += c;
				} while (true);
				for (; j7 < i; j7++) {
					int i9 = 0;
					...
					anIntArray115[j7] = i9;
					aSoundEnvelope_112.method328(i + 1);
				}
	...
	public void method169(Stream stream) {
		...
		aSoundEnvelope_98.method325(stream);
		aSoundEnvelope_99 = new SoundEnvelope();
		aSoundEnvelope_99.method325(stream);
		int i = stream.readUnsignedByte();
		if (i != 0) {
			stream.currentOffset--;
			aSoundEnvelope_100 = new SoundEnvelope();
			aSoundEnvelope_100.method325(stream);
			aSoundEnvelope_101 = new SoundEnvelope();
			aSoundEnvelope_101.method325(stream);
		}
		i = stream.readUnsignedByte();
		if (i != 0) {
			stream.currentOffset--;
			aSoundEnvelope_102 = new SoundEnvelope();
			aSoundEnvelope_102.method325(stream);
			aSoundEnvelope_103 = new SoundEnvelope();
			aSoundEnvelope_103.method325(stream);
		}
		i = stream.readUnsignedByte();
		if (i != 0) {
			stream.currentOffset--;
			aSoundEnvelope_104 = new SoundEnvelope();
			aSoundEnvelope_104.method325(stream);
			aSoundEnvelope_105 = new SoundEnvelope();
			aSoundEnvelope_105.method325(stream);
		}
		for (int j = 0; j < 10; j++) {
		...
		aSoundFilter_111.decode(stream, aSoundEnvelope_112);
	}
	...
	private SoundFilter aSoundFilter_111;
