...
final class Class56_Sub1_Sub2 extends AbstractMidiController implements Runnable
{
    ...
    private MidiFile aMidiFile_1857 = new MidiFile();
    ...
    final synchronized void playMidi(int i, byte[] is, int i_6_,
		...
		for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
			...
			while (!aMidiFile_1857.method521()) {
				aMidiFile_1857.method520(i_9_);
				if (aMidiFile_1857.anIntArray216[i_9_] != 0) {
					bool_7_ = false;
					break;
				}
				method847(i_6_ ^ 0x70, 0L, i_9_);
			}
		    aMidiFile_1857.method522(i_9_);
		}
		if (bool_7_) {
			if (aBoolean1854)
	...
	if (aMidiFile_1857.method527()) {
	    int i_11_ = anInt1855;
	    int i_12_ = -200;
	    int i_13_ = aRunnable_Impl1_1852.method14(-29810);
	    long l = ((long) (i_11_ - (i_13_ + i_12_))
		      * (long) (aMidiFile_1857.anInt213 * 1000));
	    for (;;) {
		int i_14_ = aMidiFile_1857.method536();
		int i_15_ = aMidiFile_1857.anIntArray216[i_14_];
		long l_16_ = aMidiFile_1857.method532(i_15_);
		if (l < l_16_)
		    break;
		while (i_15_
		       == aMidiFile_1857.anIntArray216[i_14_]) {
		    aMidiFile_1857.method526(i_14_);
		    method847(126, l_16_, i_14_);
		    if (aMidiFile_1857.method521()) {
			aMidiFile_1857.method522(i_14_);
			if (aMidiFile_1857.method531()) {
			    if (aBoolean1854)
		    ...
		    aMidiFile_1857.method520(i_14_);
		    aMidiFile_1857.method522(i_14_);
		}
	    }
	    if (i > -90)
    ...
    private final void method847(int i, long l, int i_17_) {
    	int i_18_ = aMidiFile_1857.method529(i_17_);
    	if (i_18_ != 1) {
    		if ((i_18_ & 0x80) != 0) {
    			int i_19_  = (int) (l / (long) (aMidiFile_1857.anInt213 * 1000));
