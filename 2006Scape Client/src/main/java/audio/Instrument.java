...
public final class Instrument {
  ...
  public int[] synthesize(int length, int rate) {
    ...
    if (pitchModifierEnvelope != null) {
      ...
      l =
          (int)
              ((pitchModifierEnvelope.end - pitchModifierEnvelope.start) * 32.768000000000001D / d);
    ...
    if (volumeModifierEnvelope != null) {
      ...
      k1 =
          (int)
              ((volumeModifierEnvelope.end - volumeModifierEnvelope.start)
                  * 32.768000000000001D
                  / d);
    ...
    for (int j2 = 0; j2 < 5; j2++) {
      if (oscillatorVolume[j2] != 0) {
        ...
        oscillatorPitchStep[j2] =
            (int)
                ((pitchEnvelope.end - pitchEnvelope.start)
                    * 32.768000000000001D
                    * Math.pow(1.0057929410678534D, oscillatorPitch[j2])
                    / d);
      ...
      for (int l5 = 0; l5 < 5; l5++) {
        if (oscillatorVolume[l5] != 0) {
          ...
          if (l6 < length) {
            sampleBuffer[l6] +=
                evaluateWaveform(
                    j4 * oscillatorVolumeStep[l5] >> 15, oscillatorPhase[l5], pitchEnvelope.form);
    ...
    if (soundFilter.filterPairs[0] > 0 || soundFilter.filterPairs[1] > 0) {
      ...
      if (length >= i5 + i6) {
        ...
        for (; j7 < l7; j7++) {
          int j8 =
              (int) ((long) sampleBuffer[j7 + i5] * (long) SoundFilter.forwardMultiplierInt >> 16);
          for (int k8 = 0; k8 < i5; k8++) {
            j8 +=
                (int)
                    ((long) sampleBuffer[j7 + i5 - 1 - k8]
                            * (long) SoundFilter.intCoefficients[0][k8]
                        >> 16);
          }
          ...
          for (int j9 = 0; j9 < j7; j9++) {
            j8 -=
                (int)
                    ((long) sampleBuffer[j7 - 1 - j9] * (long) SoundFilter.intCoefficients[1][j9]
                        >> 16);
          }
        ...
        do {
          ...
          for (; j7 < l7; j7++) {
            int l8 =
                (int)
                    ((long) sampleBuffer[j7 + i5] * (long) SoundFilter.forwardMultiplierInt >> 16);
            for (int k9 = 0; k9 < i5; k9++) {
              l8 +=
                  (int)
                      ((long) sampleBuffer[j7 + i5 - 1 - k9]
                              * (long) SoundFilter.intCoefficients[0][k9]
                          >> 16);
            }
            ...
            for (int i10 = 0; i10 < i6; i10++) {
              l8 -=
                  (int)
                      ((long) sampleBuffer[j7 - 1 - i10]
                              * (long) SoundFilter.intCoefficients[1][i10]
                          >> 16);
            }
        ...
        for (; j7 < length; j7++) {
          ...
          for (int l9 = j7 + i5 - length; l9 < i5; l9++) {
            i9 +=
                (int)
                    ((long) sampleBuffer[j7 + i5 - 1 - l9]
                            * (long) SoundFilter.intCoefficients[0][l9]
                        >> 16);
          }
          ...
          for (int j10 = 0; j10 < i6; j10++) {
            i9 -=
                (int)
                    ((long) sampleBuffer[j7 - 1 - j10] * (long) SoundFilter.intCoefficients[1][j10]
                        >> 16);
          }
