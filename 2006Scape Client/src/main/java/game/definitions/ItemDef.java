...
public final class ItemDef {
  ...
  public static Sprite getSprite(int i, int j, int k) {
    ...
    model.transformVertices(
        itemDef.modelRotation2,
        itemDef.zRotation,
        itemDef.modelRotation1,
        itemDef.offsetX,
        l3 + model.modelHeight / 2 + itemDef.offsetY,
        i4 + itemDef.offsetY);
  ...
  public int id;
  public static MRUCache spriteCache = new MRUCache(100);
