...
public class CameraManager {
  ...
  public void calcCameraPos() {
    ...
    if (game.xCameraPos < i) {
      game.xCameraPos +=
          game.cameraMoveSpeed + (i - game.xCameraPos) * game.cameraMoveAcceleration / 1000;
      if (game.xCameraPos > i) {
        game.xCameraPos = i;
      }
    }
    if (game.xCameraPos > i) {
      game.xCameraPos -=
          game.cameraMoveSpeed + (game.xCameraPos - i) * game.cameraMoveAcceleration / 1000;
      if (game.xCameraPos < i) {
        game.xCameraPos = i;
      }
    }
    if (game.zCameraPos < k) {
      game.zCameraPos +=
          game.cameraMoveSpeed + (k - game.zCameraPos) * game.cameraMoveAcceleration / 1000;
      if (game.zCameraPos > k) {
        game.zCameraPos = k;
      }
    }
    if (game.zCameraPos > k) {
      game.zCameraPos -=
          game.cameraMoveSpeed + (game.zCameraPos - k) * game.cameraMoveAcceleration / 1000;
      if (game.zCameraPos < k) {
        game.zCameraPos = k;
      }
    }
    if (game.yCameraPos < j) {
      game.yCameraPos +=
          game.cameraMoveSpeed + (j - game.yCameraPos) * game.cameraMoveAcceleration / 1000;
      if (game.yCameraPos > j) {
        game.yCameraPos = j;
      }
    }
    if (game.yCameraPos > j) {
      game.yCameraPos -=
          game.cameraMoveSpeed + (game.yCameraPos - j) * game.cameraMoveAcceleration / 1000;
      if (game.yCameraPos < j) {
        game.yCameraPos = j;
      }
    }
    ...
    if (game.yCameraCurve < l1) {
      game.yCameraCurve +=
          game.cameraAdjustSpeed + (l1 - game.yCameraCurve) * game.cameraAdjustAcceleration / 1000;
      if (game.yCameraCurve > l1) {
    ...
    if (game.yCameraCurve > l1) {
      game.yCameraCurve -=
          game.cameraAdjustSpeed + (game.yCameraCurve - l1) * game.cameraAdjustAcceleration / 1000;
      if (game.yCameraCurve < l1) {
        game.yCameraCurve = l1;
      }
    }
