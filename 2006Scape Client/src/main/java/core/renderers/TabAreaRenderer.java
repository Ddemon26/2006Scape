...
public final class TabAreaRenderer {
  ...
  public void drawButton(boolean enabled, int x, int y, int width) {
    StreamLoader streamLoader_2 =
        game.streamLoaderForName(4, "2d graphics", "media", game.expectedCRCs[4], 40);
      ...
      if (game.tabInterfaceIDs[game.tabID] != -1) {
        if (game.tabID == 7 && ClientSettings.CUSTOM_SETTINGS_TAB) {
          try {
            ...
            game.boldFont.textCenterShadow(
            ...
            game.boldFont.textCenterShadow(
                ...
                centerX,
                GameUtils.intToKOrMil(game.customSettingMinItemValue) + " gp",
                currentY + textBottom,
                true);
