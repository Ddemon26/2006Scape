    ...
    if (ClientSettings.SHOW_NAVBAR) {
      try {
        ...
        ImageIcon backgroundImg =
            new ImageIcon(Objects.requireNonNull(this.getClass().getResource("/navbar.gif")));
        ImageIcon menuImg =
            new ImageIcon(
                Objects.requireNonNull(this.getClass().getResource("/navbar_mainmenu.gif")));
        ImageIcon companyImg =
            new ImageIcon(Objects.requireNonNull(this.getClass().getResource("/navbar_jagex.gif")));
        ImageIcon worldmapImg =
            new ImageIcon(
                Objects.requireNonNull(this.getClass().getResource("/navbar_worldmap.gif")));
        ImageIcon manualImg =
            new ImageIcon(
                Objects.requireNonNull(this.getClass().getResource("/navbar_manual.gif")));
        ImageIcon rulesImg =
            new ImageIcon(Objects.requireNonNull(this.getClass().getResource("/navbar_rules.gif")));
        ...
        worldSelectText.addMouseListener(
            new MouseAdapter() {
              @Override
              public void mouseEntered(MouseEvent e) {
