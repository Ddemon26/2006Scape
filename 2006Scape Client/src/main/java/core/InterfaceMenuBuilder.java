    ...
    void buildInterfaceMenu(int x, RSInterface parent, int mouseX, int y, int mouseY, int scroll) {
        ...
        for (int idx = 0; idx < childCount; idx++) {
            ...
            if ((child.hoverTarget >= 0 || child.hoverTextColor != 0)
                    && mouseX >= childX && mouseY >= childY && mouseX < childX + child.width && mouseY < childY + child.height) {
            ...
            if (child.type == 0) {
                ...
                if (child.scrollMax > child.height) {
                    game.handleScrollbarInput(childX + child.width, child.height, mouseX, mouseY, child, childY, true, child.scrollMax);
                }
            } else {
                if (child.atActionType == 1 && mouseX >= childX && mouseY >= childY && mouseX < childX + child.width && mouseY < childY + child.height) {
                    ...
                    if (!flag) {
                        game.menuActionName[game.menuActionRow] = game.showInfo ? child.tooltip + ", " + child.id : child.tooltip;
                        game.menuActionID[game.menuActionRow] = 315;
                        game.menuActionCmd3[game.menuActionRow] = child.id;
                        game.menuActionRow++;
                    }
                }
                if (child.atActionType == 2 && game.spellSelected == 0 && mouseX >= childX && mouseY >= childY && mouseX < childX + child.width && mouseY < childY + child.height) {
                ...
                if (child.atActionType == 6 && !game.actionPending && mouseX >= childX && mouseY >= childY && mouseX < childX + child.width && mouseY < childY + child.height) {
                    game.menuActionName[game.menuActionRow] = game.showInfo ? child.tooltip + ", " + child.id : child.tooltip;
                            ...
                            if (mouseX >= j3 && mouseY >= k3 && mouseX < j3 + 32 && mouseY < k3 + 32) {
                                ...
                                if (child.inv[index] > 0) {
                                    ...
                                    if (game.spellSelected == 1 && child.isInventoryInterface) {
                                        ...
                                        if (child.isInventoryInterface) {
                                            for (int j4 = 4; j4 >= 3; j4--) {
                                                if (itemDef.actions != null && itemDef.actions[j4] != null) {
                                                    game.menuActionName[game.menuActionRow] = itemDef.actions[j4] + " @lre@" + itemDef.name;
                                                    if (j4 == 3) {
                                            ...
                                            for (int i4 = 2; i4 >= 0; i4--) {
                                                if (itemDef.actions[i4] != null) {
                                                    if (game.shiftDown) {
                                                        ...
                                                        game.menuActionName[game.menuActionRow] = itemDef.actions[i4] + " @lre@" + itemDef.name;
                                                        if (i4 == 0) {
                                        ...
                                        if (child.actions != null) {
                                            for (int k4 = 4; k4 >= 0; k4--) {
                                                if (child.actions[k4] != null) {
                                                    game.menuActionName[game.menuActionRow] = child.actions[k4] + " @lre@" + itemDef.name;
                                                    if (k4 == 0) {
                                        ...
                                        game.menuActionName[game.menuActionRow] = "Examine @lre@" + itemDef.name + (game.showInfo ? " @gre@(@whi@" + (child.inv[index] - 1) + "@gre@)" : "");
