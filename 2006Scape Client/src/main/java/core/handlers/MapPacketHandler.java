...
public final class MapPacketHandler {
  ...
  public void handleMapPackets(Stream stream, int j) {
    ...
    if (j == 105) {
      ...
      int i14 = l11 >> 4 & 0xf;
      int i16 = l11 & 7;
      if (game.myPlayer.smallX[0] >= k3 - i14
          && game.myPlayer.smallX[0] <= k3 + i14
          && game.myPlayer.smallY[0] >= j6 - i14
          && game.myPlayer.smallY[0] <= j6 + i14
          && game.soundEffectEnabled
          && !game.lowMem
          && game.currentSound < 50) {
      ...
      if (j4 >= 0 && i7 >= 0 && j4 < 103 && i7 < 103) {
        ...
        if (j16 == 0) {
          BoundaryObject boundaryObject =
              game.worldController.getBoundaryObject(game.plane, j4, i7);
        ...
        if (j16 == 3) {
          TileDecoration tileDecoration =
              game.worldController.getTileDecoration(i7, j4, game.plane);
      ...
      if (player != null) {
        ...
        if (model != null) {
          ...
          player.animationBaseHeight =
              game.getTileHeight(game.plane, player.animationBaseZ, player.animationBaseX);
          if (byte2 > byte0) {
            byte byte4 = byte2;
            byte2 = byte0;
            byte0 = byte4;
    ...
    if (j == 151) {
      ...
      // System.out.println("id: " + j10 + " x:" + (this.baseX + game.mapEventX) + " y:" +
      // (this.baseY + game.mapEventY));
      ...
      if (i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104) {
        ...
        GraphicsObject graphicsObject =
            new GraphicsObject(
                ...
                j15,
                k10,
                game.getTileHeight(game.plane, l7, i5) - l12,
                l7,
                i5);
      ...
      if (l5 >= 0
        ...
        Projectile projectile =
            new Projectile(
                ...
                j21,
                game.plane,
                game.getTileHeight(game.plane, k8, l5) - i18,
                k8,
                l5,
                l15,
                i17);
        projectile.track(
            k19 + game.loopCycle, k13, game.getTileHeight(game.plane, k13, j11) - l18, j11);
